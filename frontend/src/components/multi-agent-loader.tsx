...
const steps = [
    {
        ...
        label: '正在分析圖片菜單...',
        icon: Camera,
        duration: 3000, // Estimated time for OCR
    },
    {
        id: 'review',
        label: '正在分析 Google 評論...',
        icon: MessageSquare,
        duration: 2500, // Estimated time for Review analysis
    },
    {
        id: 'search',
        label: '正在搜尋食記推薦...',
        icon: Search,
        duration: 3500, // Estimated time for Search
    },
    {
        id: 'aggregation',
        label: '正在統整您的必吃菜單...',
        icon: Sparkles,
        duration: 2000, // Final aggregation
    },
];
